...
public class TriangleCounter1 extends Configured implements Tool
{
    ...
    public int run(String[] args) throws Exception
    {
        ...
        job1.setJarByClass(TriangleCounter1.class);
        ...
        job2.setJarByClass(TriangleCounter1.class);
        ...
        job3.setJarByClass(TriangleCounter1.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TriangleCounter1(), args);
        System.exit(res);
    }
}
